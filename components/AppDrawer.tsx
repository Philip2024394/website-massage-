...
import { AppDrawer as CleanAppDrawer } from './AppDrawerClean';

export const AppDrawer = CleanAppDrawer;
export default CleanAppDrawer;
...
interface AppDrawerProps {
    ...
    // Translation function or dictionary
    t?: any;
...
export const AppDrawer: React.FC<AppDrawerProps> = ({
    ...
    // Translator adapter: supports function t('a.b.c') or object t.a.b.c
    const translate = (key: string): string => {
        // 1) Function-style translator
        ...
        const fallbacks: Record<string, string> = {
            ...
            'home.menu.sections.locations': 'Locations',
            'home.menu.sections.massageServices': 'Massage Services',
            'home.menu.sections.helpSupport': 'Help & Support',
            'home.menu.sections.loginCreateAccount': 'Login / Create Account',

            // Primary items
            'home.menu.accommodationMassageService': 'Accommodation With Massage Service',
            'home.menu.joinIndastreet': 'Join Indastreet',
            'home.menu.massageJobs': 'Massage Jobs',
            'home.menu.howItWorks': 'How It Works',
            'home.menu.aboutUs': 'About Us',
            'home.menu.companyProfile': 'Company Profile',
            'home.menu.contact': 'Contact Us',
            'home.menu.blog': 'Blog',

            // Location items
            'home.menu.massageInBali': 'Massage in Bali',

            // Services
            'home.menu.traditionalBalineseMassage': 'Traditional Balinese Massage',
            'home.menu.deepTissueMassage': 'Deep Tissue Massage',

            // Help
            'home.menu.faq': 'FAQ',

            // Portals
            'home.menu.therapistPortal': 'Therapist Portal',
            'home.menu.massageSpaPortal': 'Massage & Spa Portal',
            'home.menu.websitePartnersPortal': 'Website Partners Portal',

            // Footer
            'home.menu.qrCode': 'QR Code',
            'home.menu.terms': 'Terms',
            'home.menu.privacy': 'Privacy',
        };
    ...
    const handleItemClick = (callback?: () => void, fallbackPage?: string) => {
        if (callback) {
            try { callback(); } catch (error) { console.error('Callback error:', error); }
            onClose();
        } else if (fallbackPage && onNavigate) {
            try { onNavigate(fallbackPage); } catch {}
            onClose();
        }
    };
                    ...
                    <nav className="flex-grow overflow-y-auto p-4">
                        <div className="space-y-3">
                            ...
                            >
                                ...
                                <span className="font-medium">{translate('home.menu.joinIndastreet')}</span>
                            </button>
                            ...
                            >
                                ...
                                <span className="font-medium">{translate('home.menu.massageJobs')}</span>
                            </button>
                            ...
                            >
                                ...
                                <span className="font-medium">{translate('home.menu.howItWorks')}</span>
                            </button>
                            ...
                            >
                                ...
                                <span className="font-medium">{translate('home.menu.aboutUs')}</span>
                            </button>
                            ...
                            >
                                ...
                                <span className="font-medium">{translate('home.menu.companyProfile')}</span>
                            </button>
                            ...
                            >
                                ...
                                <span className="font-medium">{translate('home.menu.contact')}</span>
                            </button>
                            ...
                            >
                                ...
                                <span className="font-medium">{translate('home.menu.blog')}</span>
                            </button>

                            {/* LOCATIONS */}
                            <div className="border-t border-gray-200 pt-3 mt-3">
                                <h3 className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-2">
                                    {translate('home.menu.sections.locations')}
                                </h3>
                                <button
                                ...
                                >
                                    ...
                                    <span className="font-medium">{translate('home.menu.massageInBali')}</span>
                                </button>
                            </div>
                            ...
                            <div className="border-t border-gray-200 pt-3 mt-3">
                                <h3 className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-2">
                                    {translate('home.menu.sections.massageServices')}
                                </h3>
                                <button
                                ...
                                >
                                    ...
                                    <span className="font-medium">{translate('home.menu.traditionalBalineseMassage')}</span>
                                </button>
                                ...
                                >
                                    ...
                                    <span className="font-medium">{translate('home.menu.deepTissueMassage')}</span>
                                </button>
                            </div>
                            ...
                            <div className="border-t border-gray-200 pt-3 mt-3">
                                <h3 className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-2">
                                    {translate('home.menu.sections.helpSupport')}
                                </h3>
                                <button
                                ...
                                >
                                    ...
                                    <span className="font-medium">{translate('home.menu.faq')}</span>
                                </button>
                            </div>
