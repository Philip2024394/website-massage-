...
const PWAInstallIOSModal: React.FC<PWAInstallIOSModalProps> = ({ visible, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative z-10 w-[92%] max-w-md bg-white rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div className="p-5 text-gray-800">
          <ol className="list-decimal list-inside space-y-2 text-sm">
            ...
            <li>Confirm the name, then tap <span className="font-semibold">Add</span>.</li>
          </ol>
