  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed top-4 left-4 p-2 bg-white rounded-full shadow-lg border border-gray-200 hover:shadow-xl transition-all"
            ...
            <div className="space-y-4">
              <label className="flex items-center justify-between">
                ...
                <input
                  ...
                  onChange={(e) => setUserPreferences(prev => ({ ...prev, sound: e.target.checked }))}
                  className="toggle"
                />
              </label>
              ...
              <label className="flex items-center justify-between">
                ...
                <input
                  ...
                  onChange={(e) => setUserPreferences(prev => ({ ...prev, push: e.target.checked }))}
                  className="toggle"
                />
              </label>
              ...
              <label className="flex items-center justify-between">
                ...
                <input
                  ...
                  onChange={(e) => setUserPreferences(prev => ({ ...prev, sms: e.target.checked }))}
                  className="toggle"
                />
              </label>
              ...
              <label className="flex items-center justify-between">
                ...
                <input
                  ...
                  onChange={(e) => setUserPreferences(prev => ({ ...prev, email: e.target.checked }))}
                  className="toggle"
                />
              </label>
              ...
              <label className="flex items-center justify-between">
                ...
                <input
                  type="checkbox"
                  checked={userPreferences.doNotDisturb}
                  onChange={(e) => setUserPreferences(prev => ({ ...prev, doNotDisturb: e.target.checked }))}
                  className="toggle"
                />
              </label>
            </div>
