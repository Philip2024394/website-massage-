    ...
    return (
        <>
            ...
            <div className="mx-4 mb-2 flex items-center justify-between">
                ...
                {/* Conditional SafePass Button (Only if verified by admin) */}
                {(() => {
                    // Only show SafePass if verified by admin
                    const showSafePass = (therapist as any).hotelVillaSafePassStatus === 'active' || therapist.hasSafePassVerification;
                    
                    console.log('🔍 SafePass Debug [UPDATED]:', {
                        therapistName: therapist.name,
                        hotelVillaSafePassStatus: (therapist as any).hotelVillaSafePassStatus,
                    ...
                    return showSafePass ? (
                        // SafePass Button - Opens verification modal (Only if admin verified)
                        <button
                            type="button"
                            onClick={(e) => {
                                e.preventDefault();
                    ...
                    ) : null; // No button if not verified
                })()}
            </div>
