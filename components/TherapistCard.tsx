        ...
        <>
            ...
            <div className="grid grid-cols-3 gap-2 text-center text-sm mt-1 px-4">
                ...
                <div className={`p-2 rounded-lg border shadow-md relative transition-all duration-300 min-h-[75px] flex flex-col justify-center ${
                    ...
                    {/* Star Rating - Top Edge Center (50% inside, 50% outside) */}
                    {displayRating && (
                        <div className="absolute -top-2.5 left-1/2 -translate-x-1/2 bg-yellow-400 text-white text-xs font-bold px-1.5 py-0.5 rounded-full flex items-center gap-0.5 shadow-md">
