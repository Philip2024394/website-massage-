...
import { Booking, ProviderResponseStatus } from '../types';
            ...
            <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-2">
                    {isAwaitingResponse && !hasTimedOut && (
                        <span className="px-3 py-1.5 bg-gradient-to-r from-yellow-100 to-amber-100 text-yellow-800 text-xs font-semibold rounded-full flex items-center gap-1 border border-yellow-200 shadow-sm animate-pulse">
