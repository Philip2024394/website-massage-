    ...
    return (
        <div className="relative">
            ...
            <div className="relative h-48 sm:h-56 overflow-hidden">
                ...
                <div className={`absolute top-3 shadow-lg flex items-center gap-1.5 ${therapist.isVerified ? 'left-20' : 'left-3'} bg-black/70 backdrop-blur-sm rounded-full px-3 py-1.5`}>
