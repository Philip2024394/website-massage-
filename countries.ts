...
export const COUNTRIES = [
    ...
    { name: "European Union (Euro)", code: "EU", dial_code: "+00" },

    // Full ISO list (sampled and expanded)
...
// Optional: default coordinates for key markets to center maps on selection
export const COUNTRY_DEFAULT_COORDS: Record<string, { lat: number; lng: number; city: string }> = {
    ID: { lat: -6.200000, lng: 106.816666, city: 'Jakarta' },
    MY: { lat: 3.139003, lng: 101.686852, city: 'Kuala Lumpur' },
    SG: { lat: 1.352083, lng: 103.819839, city: 'Singapore' },
    AU: { lat: -33.868820, lng: 151.209290, city: 'Sydney' },
    GB: { lat: 51.507351, lng: -0.127758, city: 'London' },
    US: { lat: 40.712776, lng: -74.005974, city: 'New York' },
    EU: { lat: 50.110924, lng: 8.682127, city: 'Frankfurt' },
};
