...
export function PersistentChatWindow() {
  ...
  // Also check for therapist stability to prevent mid-render crashes
  if (!chatState.isOpen || !therapist || !therapist.id) {
    return null;
  }
  ...
  return (
    ...
    >
      ...
      <div className="chat-theme-wrapper">
        ...
        {/* 🆕 ELITE FIX: Connection Degradation Banner - Facebook/Amazon Standard Transparency */}
        {chatState.isAppwriteDegraded && chatState.degradationReason && (
          <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 mb-2" role="alert">
            <div className="flex items-start">
              ...
              <button
                ...
                className="ml-auto flex-shrink-0 text-xs text-yellow-600 hover:text-yellow-800 underline"
              >
                Retry Connection
              </button>
            </div>
      ...
      <div className="flex-1 bg-white flex flex-col overflow-y-auto" style={{ 
        ...
        {/* Chat Messages Step - Conditionally rendered to prevent DOM errors */}
        {bookingStep === 'chat' && (
        <div className="flex flex-col h-full">
          ...
          <div className="flex-1 min-h-0">
            <div className="p-4 space-y-3">
              ...
              {/* Message list - render array directly without Fragment wrapper to prevent DOM errors */}
