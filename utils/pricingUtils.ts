...
export const pricingUtils = {
    ...
    getTherapistPricing: (therapist: import('../types').Therapist) => {
    ...
    hasValidPricing: (therapist: import('../types').Therapist) => {
    ...
    formatPriceForCard: (therapist: import('../types').Therapist, duration: "60" | "90" | "120") => {
        const pricing = pricingUtils.getTherapistPricing(therapist);
