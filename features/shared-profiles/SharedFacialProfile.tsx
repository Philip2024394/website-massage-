/**
 * Shared Facial Profile Page
 * Uses the same clean pattern
 */
...
export const SharedFacialProfile: React.FC<SharedFacialProfileProps> = ({
    facialPlaces,
    selectedPlace,
    userLocation,
    loggedInCustomer,
    ...
    useEffect(() => {
        ...
        const title = `${place.name} | Professional Facial Spa | IndaStreet`;
        const description = `Book facial services at ${place.name}${place.city ? ` in ${place.city}` : ''}. Professional facial treatments, verified specialists.`;
        const shareUrl = generateFacialShareURL(place);
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="mt-6 bg-white rounded-2xl shadow-lg p-6">
                        ...
                        <div className="flex flex-wrap gap-3">
                            <button
                                onClick={() => {
                                    const url = generateFacialShareURL(place);
                                    const text = generateShareText(place.name, 'facial', place.city);
...
export default SharedFacialProfile;
