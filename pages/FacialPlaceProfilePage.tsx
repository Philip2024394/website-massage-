...
import { useMassagePlaceProfile as useFacialPlaceProfile } from '../hooks/useMassagePlaceProfile';
...
interface FacialPlaceProfilePageProps {
    place: Place;
    onBack: () => void;
    onBook?: () => void;
...
/**
 * Facial Place Profile Page
 * Displays detailed information about a Facial Place
 * Refactored using custom hook and modular components
 */
const FacialPlaceProfilePage: React.FC<FacialPlaceProfilePageProps> = ({ 
    place, 
    onBack, 
    onBook, 
    userLocation, 
    ...
    const handleAnonymousReviewSubmit = async (reviewData: any) => {
        try {
            console.log('Review submitted for Facial Place:', reviewData);
    ...
    const handleBookNowClick = () => {
        if (place.whatsappNumber) {
            ...
            alert('WhatsApp number not available for this Facial Place');
        }
    };
    ...
    const handleBikeTaxi = async () => {
        try {
            ...
            if (!placeCoords.lat || !placeCoords.lng) {
                alert('Place location not available. Please contact the Facial Place.');
                return;
            }
    ...
    return (
        <div className="min-h-screen bg-gray-50 overflow-x-hidden w-full max-w-full">
            {/* Header with brand, language selector, and burger menu */}
            <ProfileHeader
            ...
            <AppDrawer
                ...
                onMassagePlacePortalClick={onFacialPlacePortalClick}
            ...
            <main className="w-full max-w-full mx-auto px-4 py-6 pb-24 overflow-x-hidden">
                <PageNumberBadge pageNumber={83} pageName="FacialPlaceProfile" isLocked={false} />
...
export default FacialPlaceProfilePage;
