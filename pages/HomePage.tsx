                    ...
                    {fabMenuOpen && (
                        <div className="fixed bottom-[140px] right-6 flex flex-col gap-3 z-[60] animate-slideUp">
                            ...
                            <button
                                ...
                                className="backdrop-blur-xl bg-black/70 hover:bg-black/80 shadow-2xl w-14 h-14 rounded-full flex items-center justify-center transition-all duration-200 hover:scale-110 border border-white/10 will-change-transform"
                            ...
                            <button
                                ...
                                className="backdrop-blur-xl bg-black/70 hover:bg-black/80 shadow-2xl w-14 h-14 rounded-full flex items-center justify-center transition-all duration-200 hover:scale-110 border border-white/10"
