        ...
        <div className="min-h-screen bg-gray-50 p-6">
            <div className="max-w-7xl mx-auto space-y-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3">
                    ...
                    <KpiCard icon={<Activity className="w-4 h-4 text-red-600" />} label="Conversion" value={`${(analytics.platformConversionRate || 0).toFixed(1)}%`} sub={`${formatNumber(analytics.averageBookingsPerUser)} bk/user`} />
                </div>
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            <div className="bg-white rounded-2xl p-6 shadow-lg">
                                <h3 className="text-xl font-bold text-gray-900 mb-4 flex items-center gap-2"><Activity className="w-6 h-6 text-brand-500" />Therapist Network</h3>
