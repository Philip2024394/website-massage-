        ...
        try {
            if (isSignUp) {
                ...
                if (response.success && response.userId) {
                    ...
                    if (response.error?.includes('Collection') || response.error?.includes('could not be found')) {
                        throw new Error('Database setup required. Please contact administrator to set up collections in Appwrite.');
                    }
