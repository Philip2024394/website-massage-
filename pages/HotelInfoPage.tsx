            ...
            <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
                ...
                <div className="max-w-6xl mx-auto px-4 py-16">
                    ...
                    <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100 p-8 mb-16">
                        <h2 className="text-3xl font-bold text-gray-900 mb-2 text-center">Why Hotels & Villas Choose IndaStreet</h2>
                        ...
                        <div className="bg-gradient-to-r from-green-500 to-emerald-600 rounded-xl p-4 pb-20 mb-8 mx-auto max-w-md">
                            <div className="text-center">
                                ...
                                <p className="text-white font-semibold text-lg">100% Free for Hotels & Spas</p>
                                <p className="text-green-100 text-sm mt-1">No registration fees • No commissions • Forever free</p>
                            </div>
                        </div>
