                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div className="flex-1">
                                    ...
                                    <div className="space-y-2 text-sm text-purple-700">
                                        <p><strong>Membership Required:</strong> Customize your hotel brand profile with paid membership plans.</p>
                                        <ul className="list-disc list-inside space-y-1 ml-4">
                                            <li>Upload custom banner and logo images</li>
                                            <li>Set unique hotel name and branding</li>
                                ...
                                <div className="mb-6 p-4 bg-orange-50 border border-orange-200 rounded-xl">
                                    ...
                                    <div className="space-y-3">
                                        {[
                                            ...
                                            { 
                                                bookingId: 'B124', 
                                                date: 'Oct 28, 2025 - 4:30 PM', 
                                                provider: 'Ayu Prameswari', 
                                                service: '90 min', 
                                                room: '205B',
                                                amount: 350000, 
                                                commission: 70000,
                                                ...
                                                <div className="flex items-center justify-between">
                                                    <div className="flex-1">
                                                        ...
                                                        <div className="text-sm text-gray-600">
                                                            <div>🏨 Room {booking.room} • {booking.service} • {booking.date}</div>
                                    ...
                                    <div className="mt-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                                        <div className="flex items-start gap-2">
                                            ...
                                            <div className="text-xs text-blue-800">
                                                <strong>How it works:</strong> When therapists complete hotel/villa bookings, they become unavailable for new bookings until you confirm receiving your commission. This ensures proper commission tracking and therapist availability management.
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div className="flex-1">
                                    ...
                                    <div className="space-y-2 text-sm text-purple-700 mb-4">
                                        ...
                                        <ul className="list-disc list-inside space-y-1 ml-4">
                                            <li>Replace IndaStreet branding with your hotel's brand on live menus</li>
                                            <li>Display your hotel logo, name, and custom styling</li>
                                    ...
                                    <div className="bg-white p-4 rounded-lg border border-purple-200">
                                        <div className="flex items-center justify-between">
                                            <div>
                                                ...
                                                <p className="text-xs text-gray-500">Show your hotel brand instead of IndaStreet on live menus</p>
                                            </div>
                                            <div className="relative">
                                                <input
                                                    type="checkbox"
            ...
            <div className={`fixed top-0 right-0 h-full w-80 bg-white shadow-2xl z-50 transform transition-transform duration-300 ease-in-out ${
                ...
                <nav className="flex flex-col p-4 space-y-2 overflow-y-auto h-[calc(100vh-140px)]">
                    ...
                    >
                        ...
                        <span className="font-medium">Coin Rewards</span>
                    </button>
                </nav>
