...
const TherapistTermsPage: React.FC = () => {
    return (
        <div className="max-w-4xl mx-auto p-4 pb-20 sm:p-6 bg-white rounded-lg shadow-lg">
            <div className="mb-6">
                <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2"><span className="text-black">Inda</span><span className="text-orange-500">street</span> Therapist Terms of Service</h1>
