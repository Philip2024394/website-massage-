...
const TherapistTermsPage: React.FC = () => {
    return (
        <div className="max-w-4xl mx-auto p-4 sm:p-6 bg-white rounded-lg shadow-lg">
            <div className="mb-6">
                <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">IndoStreet Therapist Terms of Service</h1>
            ...
            <section className="mb-6 sm:mb-8">
                ...
                <div className="bg-yellow-50 border-l-4 border-yellow-500 p-3 sm:p-4">
                    ...
                    <ul className="list-disc list-inside space-y-2 text-gray-700 text-xs sm:text-sm break-words">
                        <li><strong>Independent Contractor:</strong> You work as a self-employed, independent contractor, NOT as an employee of IndoStreet</li>
                        ...
                        <li><strong>Insurance:</strong> IndoStreet does not provide insurance coverage; you are responsible for your own liability insurance</li>
            ...
            <section className="mb-6 sm:mb-8">
                ...
                <div className="bg-green-50 border-l-4 border-green-500 p-3 sm:p-4">
                    ...
                    <ul className="list-disc list-inside space-y-2 text-gray-700 text-xs sm:text-sm break-words">
                        ...
                        <li><strong>No Penalties:</strong> Cancelling for safety reasons will NOT affect your status or standing with IndoStreet</li>
                        <li><strong>Immediate Support:</strong> Contact IndoStreet admin immediately if you encounter any issues</li>
