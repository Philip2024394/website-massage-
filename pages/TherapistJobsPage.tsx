                    ...
                    <div className="grid grid-cols-1 gap-6">
                        {filteredListings.map((listing) => (
                            <div key={listing.$id} className="bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden border-t-4 border-orange-500 relative flex">
                                ...
                                <div className="flex flex-col gap-3 py-6 pl-4 pr-2 bg-gray-50 border-r border-gray-200">
                                    {/* WhatsApp */}
                                    <button
                                        onClick={(e) => {
                                            e.stopPropagation();
                                            const text = `Check out this therapist profile: ${listing.jobTitle}`;
                                            const url = window.location.href;
                                            window.open(`https://wa.me/?text=${encodeURIComponent(text + ' ' + url)}`, '_blank');
                                        }}
                                        className="w-10 h-10 bg-green-500 hover:bg-green-600 rounded-full flex items-center justify-center shadow-lg transform hover:scale-110 transition-all"
                                    ...
                                    <button
                                        ...
                                        className="w-10 h-10 bg-blue-600 hover:bg-blue-700 rounded-full flex items-center justify-center shadow-lg transform hover:scale-110 transition-all"
                                    ...
                                    <button
                                        onClick={(e) => {
                                            e.stopPropagation();
                                            const text = `Check out this therapist profile: ${listing.jobTitle} ${window.location.href}`;
                                            navigator.clipboard.writeText(text);
                                            alert('Link copied! You can now paste it in Instagram.');
                                        }}
                                        className="w-10 h-10 bg-gradient-to-br from-purple-600 via-pink-600 to-orange-500 hover:from-purple-700 hover:via-pink-700 hover:to-orange-600 rounded-full flex items-center justify-center shadow-lg transform hover:scale-110 transition-all"
                                    ...
                                    <button
                                        ...
                                        className="w-10 h-10 bg-black hover:bg-gray-800 rounded-full flex items-center justify-center shadow-lg transform hover:scale-110 transition-all"
