        ...
        <div className="min-h-screen bg-gradient-to-br from-orange-50 to-white">
            ...
            <div className="max-w-4xl mx-auto px-4 py-12">
                ...
                <div className="text-center mb-8">
                    <h1 className="text-4xl font-bold text-gray-900 mb-4">Unlock Job Details</h1>
                    <p className="text-gray-600 text-lg">Complete payment to access contact information</p>
                </div>
                ...
                <div className="bg-white rounded-2xl shadow-xl p-8 mb-6">
                    ...
                    {loadingBanks ? (
                        <div className="bg-gradient-to-r from-orange-50 to-orange-100 rounded-xl p-8 border-2 border-orange-200 text-center">
                ...
                <button
                    ...
                    className={`w-full py-4 px-6 rounded-xl font-bold text-lg shadow-2xl transition-all duration-300 flex items-center justify-center gap-3 ${
                    ...
                    style={paymentProof && userName && userPhone && acceptedTerms && selectedBank ? {
