...
const PWAInstallPrompt: React.FC<PWAInstallPromptProps> = ({ dashboardName = 'Dashboard' }) => {
    ...
    if (Notification.permission !== 'denied') {
      ...
      if (permission === 'granted') {
        ...
        new Notification('IndaStreet ' + dashboardName, {
          ...
          icon: '/icons/place-icon-192.png',
          badge: '/icons/place-icon-96.png',
          vibrate: [200, 100, 200],
  ...
  return (
    <>
      {/* Install Banner - Mobile Optimized with Green Theme */}
      <div className="fixed bottom-20 left-4 right-4 z-50 animate-slide-up">
        <div className="bg-gradient-to-r from-green-500 to-emerald-500 rounded-2xl shadow-2xl p-4 text-white">
          <button
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <button
                ...
                className="w-full bg-white text-green-600 font-bold py-3 px-6 rounded-xl hover:bg-gray-100 transition-all shadow-lg flex items-center justify-center gap-2"
              >
