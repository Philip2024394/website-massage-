 ...
 * ║                                                                      ║
 * ║  Generated: 2026-01-29T05:22:52.698Z                             ║
...
(() => {
  console.log('🔍 SECURITY CHECK: File access detected for ProfessionalDomain.PatientScheduling.Presentation.Interface.v1.tsx');
 ...
 * Original: TherapistCustomerBookingPage.tsx
 * Transformed: 2026-01-29T05:16:52.943Z
 * 
...
const CustomerBookingPage: React.FC<CustomerBookingPageProps> = ({ therapist, onBookingComplete }) => {
  ...
  if (!isPWAInstalled) {
    return (
      <div className="min-h-[calc(100vh-env(safe-area-inset-top)-env(safe-area-inset-bottom))] bg-gradient-to-br from-orange-500 via-orange-600 to-amber-600 flex items-center justify-center p-4">
