...
translations.en.serviceTerms = {
  ...
  serviceProviderTerms: {
    modalTitle: 'Therapist And Facial Services',
    modalSubtitle: 'Terms for therapists and facial service providers — IndaStreet',
    agreeButton: 'Agree to terms and conditions',
    title: 'Therapist And Facial Services',
    intro: 'By signing in or using IndaStreet as a therapist or facial service provider, you agree to the following terms.',
...
translations.id.serviceTerms = {
  ...
  serviceProviderTerms: {
    modalTitle: 'Therapist And Facial Services',
    modalSubtitle: 'Syarat untuk terapis dan penyedia layanan facial — IndaStreet',
    agreeButton: 'Setuju syarat dan ketentuan',
    title: 'Therapist And Facial Services',
    intro: 'Dengan masuk atau menggunakan IndaStreet sebagai terapis atau penyedia layanan facial, Anda setuju dengan ketentuan berikut.',
