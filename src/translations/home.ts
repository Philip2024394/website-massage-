...
export const homeTranslations = {
  en: {
    home: {
      ...
      therapistsSubtitle: 'We monitor provider locations and user activity to ensure a safe platform for everyone.',
      therapistsSubtitleAll: 'We monitor provider locations and user activity to ensure a safe platform for everyone.',
      therapistsSubtitleCity: 'We monitor provider locations and user activity to ensure a safe platform for everyone.',
      safetyCommitmentTitle: 'Your safety matters',
      safetyCommitmentText: 'We monitor provider locations and user activity to ensure a safe platform for everyone.',
  ...
  id: {
    home: {
      ...
      safetyCommitmentText: 'Kami memantau lokasi penyedia dan aktivitas pengguna untuk memastikan platform yang aman bagi semua.',
