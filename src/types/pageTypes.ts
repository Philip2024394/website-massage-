...
export type Page = 
    ...
    | 'therapist-login'
    | 'massage-therapist-login'
    | 'facial-therapist-login'
    | 'beautician-therapist-login'
    | 'massage-therapist-dashboard'
    | 'facial-therapist-dashboard'
    | 'beautician-therapist-dashboard'
    | 'place-login'
    | 'employer-login'
    ...
    | 'sign-in'
    | 'therapist-signup'
    | 'massage-therapist-signup'
    | 'facial-therapist-signup'
    | 'beautician-therapist-signup'
