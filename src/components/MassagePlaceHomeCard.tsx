    ...
    return (
        <div className="relative">
            ...
            <div 
                ...
                className={`bg-white rounded-2xl overflow-hidden border border-gray-200 border-t-4 border-t-amber-400 transition-all duration-300 ${readOnly ? 'cursor-default' : 'cursor-pointer hover:shadow-xl'} group ${readOnly ? 'opacity-90' : ''}`}
            >
            {/* Image Container */}
            ...
            <div className="px-4 pb-4">
                {/* Pricing — same design as beautician home service: Treatments Trending, fixed prices, list layout */}
                <div className="mb-4">
                    <style>{`
                ...
                <div className="flex gap-2">
                    ...
                    <button
                        ...
                        onClick={(e) => {
                            e.stopPropagation();
                            if (!readOnly) setShowMenuSlider(true);
                        }}
                        disabled={readOnly}
                ...
                <div className="fixed inset-0 z-[10001] flex flex-col justify-end" role="dialog" aria-modal="true" aria-label="Menu prices">
                    ...
                    <div className="relative bg-white rounded-t-2xl shadow-2xl max-h-[85vh] overflow-y-auto">
                        ...
                        <div className="p-4 space-y-3">
                            <p className="text-sm text-gray-600">{(place as any).services || 'All Massage Types'}</p>
