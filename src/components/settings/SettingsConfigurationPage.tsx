...
import { 
  Settings, User, Palette, Target, Save, RefreshCw,
  Download, Upload, Eye, EyeOff, Check, X, Info,
  AlertTriangle, ChevronRight, Search, Filter,
  Zap, Heart, Star, Trophy, Globe, Shield
} from 'lucide-react';
