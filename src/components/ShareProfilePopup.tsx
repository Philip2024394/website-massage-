/**
 * ============================================================================
 * 📤 SHARE MY PROFILE POPUP
 * ============================================================================
 * 
 * Simple, reliable profile sharing interface for members
 * 
 * Features:
 * - Copy profile URL to clipboard
 * - Share to social media platforms (WhatsApp, Facebook, Telegram, X, Email)
 * - Uses canonical public URL format: /t/{memberId}
        ...
        <div className="bg-gradient-to-r from-orange-500 to-pink-500 p-6 text-white">
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-2xl font-bold">Share My Profile</h2>
            </div>
            <button
              onClick={onClose}
        ...
        <div className="p-6">
          ...
          <div className="mb-6">
            ...
            <p className="mt-2 text-xs text-gray-500">
              ✓ Works on all platforms • ✓ No login required • ✓ Permanent link
            </p>
          </div>
          ...
          <div className="mb-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <button
                ...
                className="col-span-2 flex items-center justify-center gap-2 p-3 bg-gray-600 text-white rounded-lg hover:bg-gray-700 transition-colors"
              >
          ...
          <div className="p-3 bg-blue-50 border border-blue-200 rounded-lg">
            <p className="text-sm text-blue-800">
              <strong>💡 Tip:</strong> This link works everywhere - social media, messaging apps, email, or QR codes!
            </p>
          </div>
        </div>
      </div>
