      ...
      dialog.innerHTML = `
        <div class="bg-white rounded-lg p-6 max-w-md mx-4">
          <div class="flex items-center mb-4">
            ...
            <h3 class="text-lg font-semibold text-amber-900">Tetap Terhubung</h3>
          </div>
          ...
          <div class="flex space-x-3">
            <button id="allow-notifications" class="flex-1 bg-gradient-to-r from-amber-600 to-amber-700 text-white px-4 py-2 rounded-lg font-medium hover:from-amber-700 hover:to-amber-800">
              Izinkan Notifikasi
            </button>
