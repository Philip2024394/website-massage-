...
const TherapistTermsPage: React.FC = () => {
    return (
        <div className="max-w-4xl mx-auto p-4 pb-20 sm:p-6 bg-white rounded-lg shadow-lg">
            <div className="mb-6">
                <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2"><span className="text-black">Inda</span><span className="text-orange-500"><span className="inline-block animate-float">S</span>treet</span> Therapist Terms of Service</h1>
            ...
            <section className="mb-6 sm:mb-8">
                ...
                <div className="bg-yellow-50 border-l-4 border-yellow-500 p-3 sm:p-4 pb-20">
                    ...
                    <ul className="list-disc list-inside space-y-2 text-gray-700 text-xs sm:text-sm break-words">
                        <li><strong>Independent Contractor:</strong> You work as a self-employed, independent contractor, NOT as an employee of <span className="text-black">Inda</span><span className="text-orange-500">street</span></li>
                        ...
                        <li><strong>Insurance:</strong> <span className="text-black">Inda</span><span className="text-orange-500">street</span> does not provide insurance coverage; you are responsible for your own liability insurance</li>
            ...
            <section className="mb-6 sm:mb-8">
                ...
                <div className="bg-green-50 border-l-4 border-green-500 p-3 sm:p-4 pb-20">
                    ...
                    <ul className="list-disc list-inside space-y-2 text-gray-700 text-xs sm:text-sm break-words">
                        ...
                        <li><strong>Immediate Support:</strong> Contact <span className="text-black">Inda</span><span className="text-orange-500">street</span> admin immediately if you encounter any issues</li>
