...
const HotelVillaSafePassPage: React.FC<HotelVillaSafePassPageProps> = ({ 
  ...
  return (
    <div className="min-h-[calc(100vh-env(safe-area-inset-top)-env(safe-area-inset-bottom))] bg-white">
      {/* Hero Section */}
      <section className="bg-white border-b border-amber-100 py-16">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="text-center max-w-3xl mx-auto">
            ...
            <button
              ...
              className="mt-8 bg-amber-500 hover:bg-amber-600 text-white px-8 py-4 rounded-lg font-bold text-lg shadow-lg transition-all transform hover:scale-105"
            >
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-6xl mx-auto px-6">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 text-center mb-12">
            Why Hotels Choose <span className="text-amber-500">Inda</span><span className="text-gray-900">Street</span> Massage
          </h2>
      ...
      <section className="py-16 bg-gradient-to-r from-amber-500 to-amber-600 text-white">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button
              onClick={handleApplyNow}
              className="bg-white text-amber-600 hover:bg-gray-100 px-8 py-4 rounded-lg font-bold text-lg shadow-lg transition-all transform hover:scale-105"
            >
              Apply for Safe Pass
            </button>
            <button
              onClick={() => onNavigate('contact')}
              className="bg-amber-700 hover:bg-amber-800 text-white px-8 py-4 rounded-lg font-bold text-lg shadow-lg transition-all border-2 border-white/20"
            >
              Contact Us
            </button>
          </div>
          ...
          <div className="mt-12 grid md:grid-cols-3 gap-8 text-center">
            <div>
              ...
              <div className="text-amber-100">Certified Therapists</div>
            </div>
            <div>
              <div className="text-4xl font-bold mb-2">200+</div>
              <div className="text-amber-100">Partner Hotels & Villas</div>
            </div>
            <div>
              <div className="text-4xl font-bold mb-2">95%</div>
              <div className="text-amber-100">Approval Rate</div>
            </div>
          </div>
        </div>
      </section>
