...
const CustomerBookingPage: React.FC<CustomerBookingPageProps> = ({ therapist, onBookingComplete }) => {
  ...
  if (!isPWAInstalled) {
    return (
      <div className="min-h-[calc(100vh-env(safe-area-inset-top)-env(safe-area-inset-bottom))] bg-gradient-to-br from-orange-500 via-orange-600 to-amber-600 flex items-center justify-center p-4  " style={{ WebkitOverflowScrolling: 'touch', touchAction: 'pan-y pan-x' }}>
