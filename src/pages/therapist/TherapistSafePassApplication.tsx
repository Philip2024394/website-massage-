...
import { Shield, Upload, CheckCircle, Clock, XCircle, FileText, AlertCircle, Info } from 'lucide-react';
import safePassService from '../../services/safePassService';
import type { SafePassApplication } from '../../types/safepass.types';

interface TherapistSafePassApplicationProps {
    therapistId: string;
    therapistName: string;
}

const TherapistSafePassApplication: React.FC<TherapistSafePassApplicationProps> = ({
    therapistId,
    therapistName
}) => {
    ...
    const loadExistingApplication = async () => {
        setLoading(true);
        try {
            const app = await safePassService.getApplicationByEntity('therapist', therapistId);
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-blue-800 text-sm">
                                    ...
                                    Your SafePass card is being prepared and will be activated soon.
                                </p>
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-green-800 text-sm mb-3">
                                    Your SafePass is active! You can now offer services at hotels, villas, gyms, and private homes.
                                </p>
            ...
            <div className="max-w-3xl mx-auto">
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-6">
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            <h3 className="font-semibold text-blue-900 mb-2">What is SafePass?</h3>
                            <p className="text-blue-800 text-sm mb-3">
                                SafePass is a professional certification that allows you to provide massage services 
                                at hotels, villas, gyms, and private homes. It ensures you meet industry standards 
                                for safety, professionalism, and service excellence.
                            </p>
                            <ul className="text-blue-800 text-sm space-y-1">
                                <li>✓ Access to premium service locations</li>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="mb-6">
                            ...
                            <p className="text-xs text-gray-600 mb-3">
                                Upload required documents (company letter, police clearance, health certificate, etc.)
                            </p>
                        ...
                        <div className="mb-6 p-4 bg-gray-50 rounded-lg">
                            ...
                            <ul className="space-y-2 text-sm text-gray-700">
                                ...
                                <li className="flex items-start gap-2">
                                    <CheckCircle className="w-4 h-4 text-green-600 flex-shrink-0 mt-0.5" />
                                    <span>Company letter or business registration</span>
                                </li>
                                <li className="flex items-start gap-2">
                                    <CheckCircle className="w-4 h-4 text-green-600 flex-shrink-0 mt-0.5" />
                                    <span>Police clearance certificate (SKCK)</span>
                                </li>
                                <li className="flex items-start gap-2">
                                    <CheckCircle className="w-4 h-4 text-green-600 flex-shrink-0 mt-0.5" />
...
export default TherapistSafePassApplication;
