    ...
    return (
        <div className="h-48 w-full overflow-visible relative rounded-t-xl">
            ...
            <button
                ...
                className="absolute bottom-2 right-2 w-11 h-11 bg-white/90 hover:bg-white rounded-full flex items-center justify-center shadow-lg transition-all hover:scale-105 active:scale-95"
                title="Share place"
                aria-label="Share profile"
                style={{ minWidth: '44px', minHeight: '44px' }}
            >
                <Share2 className="w-5 h-5 text-gray-800" strokeWidth={2.5} />
            </button>
        </div>
    );
}
