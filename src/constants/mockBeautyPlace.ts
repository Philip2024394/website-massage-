...
export const MOCK_BEAUTY_PLACE = {
  ...
  mainImage: BEAUTY_IMG,
  profilePicture: BEAUTY_IMG,
  ...
  galleryImages: [
    { imageUrl: BEAUTY_IMG, header: 'Salon Space', description: 'Modern setup for nails, hair and makeup.' },
    { imageUrl: BEAUTY_IMG, header: 'Nail Station', description: 'Clean nail station with premium products.' },
    { imageUrl: BEAUTY_IMG, header: 'Hair Station', description: 'Professional hair styling and colour.' },
  ],
