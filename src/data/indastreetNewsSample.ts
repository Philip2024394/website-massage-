/**
 * Fallback sample news for IndaStreet News feed when Appwrite returns no data.
 * Matches IndastreetNewsItem from indastreetNews.service.
 */
import type { IndastreetNewsItem } from '../lib/appwrite/services/indastreetNews.service';

export const SAMPLE_NEWS: IndastreetNewsItem[] = [
  {
    id: '1',
    ...
    imageSrc: 'https://ik.imagekit.io/7grri5v7d/massage%20it.png',
  },
  {
    id: '2',
  ...
  },
  {
    ...
    imageSrc: 'https://ik.imagekit.io/7grri5v7d/massage%20its.png',
  },
  {
    id: '6',
    ...
    imageSrc: 'https://ik.imagekit.io/7grri5v7d/hot%20stones.png',
  },
  {
    id: '7',
  ...
  },
  {
    ...
    date: 'Oct 10, 2025',
    category: 'producers',
    imageSrc: 'https://ik.imagekit.io/7grri5v7d/wellness%20massages.png',
  ...
  },
  {
    ...
    date: 'Oct 5, 2025',
    category: 'good-news',
    imageSrc: 'https://ik.imagekit.io/7grri5v7d/skin%20care.png',
