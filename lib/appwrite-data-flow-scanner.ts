...
export class AppwriteDataFlowScanner {
    ...
    async scanAllCollections(results) {
        ...
        for (const collectionName of collectionNames) {
            ...
            try {
                ...
                results.errors.push(`${collectionName}: ${(error as Error as any as any as any as any as any).message}`);
            }
        }
    }
    ...
    async scanImageStorage(results) {
        ...
        try {
            ...
            results.errors.push(`Storage: ${(error as Error as any as any as any as any as any).message}`);
        }
    }
